...
For Monday: 
  ...
  - Read [Dummy variables](../files/09_dummy_variables.pdf) and [The bootstrap](10_bootstrap.pdf)
...
Complete Activity 1 and turn it in. You don't need to turn anything in for Activity 2. Complete the following exercises:
